  ...
  switch (msg.type) {
    ...
    case 'tool_use': {
      ...
      const subagentHtml = msg.subagentMessages
        ...
        : '';
      return `<div class="msg msg-tool"><details><summary>${time}<span class="tool-summary">${summary}</span></summary><div class="tool-details">${renderToolInput(msg)}${resultHtml}${subagentHtml}</div></details></div>`;
    }
